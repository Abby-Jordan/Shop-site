...
const WA_LINK = "https://wa.me/917600585983?text=Hello%2C%20I%20would%20like%20to%20place%20an%20order";
...
export default function Navbar() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-white/95 backdrop-blur-md shadow-md py-1.5" : "bg-white py-2"
        }`}
    >
