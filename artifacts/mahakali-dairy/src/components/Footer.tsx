    ...
    <footer className="bg-gray-950 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-500 text-white text-sm font-semibold px-5 py-2.5 rounded-full transition-colors"
            >
              <WAIcon /> WhatsApp Us
            </a>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}>
                  <a href={link.href} className="text-gray-500 hover:text-amber-400 text-sm transition-colors duration-200">
                    {link.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Fresh Milk", "Desi Cow Ghee", "Fresh Paneer", "Dahi / Curd", "Rasgulla", "Gulab Jamun", "Kalakand", "Kheer"].map((p) => (
                <li key={p}>
                  <a href="#products" className="text-gray-500 hover:text-amber-400 text-sm transition-colors duration-200">
                    {p}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <a href="tel:+919876543210" className="text-amber-400 hover:text-amber-300 text-sm font-medium">+91 98765 43210</a>
              </div>
              <div>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-gray-700 text-xs">Made with care for our valued customers</p>
        </div>
      </div>
    </footer>
  );
